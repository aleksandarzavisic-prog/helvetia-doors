...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ constants ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Supabase URL for storage ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */

/* Ã¢ÂÂÃ¢ÂÂ FR DOOR constants Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
const FR_DEL_ALL = [
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ App shell ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
  ...
  return (
    <div className="container">
      <div className="row" style={{justifyContent:"space-between"}}>
        ...
        <button className="btn" onClick={load}>{loading ? "LoadingÃÂ¢ÃÂÃÂ¦" : "Refresh"}</button>
      </div>
      ...
      <div className="row" style={{marginBottom:10,gap:8}}>
        <div style={{minWidth:160}}>
          ...
          <select className="input" value={selFloor}
            ...
            style={{width:"100%"}}>
            <option value="">Ã¢ÂÂ Select floor Ã¢ÂÂ</option>
      ...
      {selApt !== "" && (
        <div style={{marginBottom:10,background:"rgba(0,0,0,.2)",borderRadius:8,padding:10}}>
          <div className="row" style={{justifyContent:"space-between",marginBottom:8}}>
            <div className="small" style={{fontWeight:700}}>Apt {selApt} Ã¢ÂÂ click doors to select</div>
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Delivery Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
  ...
  return (
    <>
      ...
      <div className="card" style={{marginBottom:12}}>
        ...
        <div className="row" style={{alignItems:"flex-end"}}>
          ...
          <button className="btn primary" disabled={distributing || reversing || !hwQty} onClick={distribute}>
            {distributing ? "DistributingÃÂ¢ÃÂÃÂ¦" : "Distribute"}
          </button>
          {lastDist && (
            <button className="btn" disabled={reversing || distributing} onClick={reverseLastDist}
              ...
              {reversing ? "ReversingÃÂ¢ÃÂÃÂ¦" : "Undo last"}
            </button>
          )}
        </div>
      ...
      <div className="card" style={{marginBottom:12}}>
        ...
        <div className="small" style={{marginTop:8}}>Page {dPage + 1} of {Math.ceil(filtered.length / DPAGE_SIZE) || 1} Ã¢ÂÂ {filtered.length} doors</div>
      ...
      <div className="card">
        ...
        {filtered.length > 300 && <div className="small" style={{marginTop:10}}>(Showing first 300 ÃÂ¢ÃÂÃÂ narrow filters to see more)</div>}
      </div>
    </>
  );
}
  ...
  return (
    <div style={{padding:"10px 4px"}}>
      <div className="kv">
        ...
        <div className="small">Room</div><div>{door.room || "ÃÂ¢ÃÂÃÂ"}</div>
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Installation Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
    ...
    <>
      <div className="card" style={{marginBottom:12}}>
        <div className="row">
          ...
          <input className="input" placeholder="Search qr / apt / roomÃÂ¢ÃÂÃÂ¦" value={search} onChange={e=>setSearch(e.target.value)} style={{flex:1}}/>
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Snag Photos ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
...
function SnagPhotos({ door, onUpdate, onRefresh }) {
  ...
  const handleFiles = async (e) => {
    ...
    if (uploaded > 0) {
      ...
      setUploadMsg("Upload failed ÃÂ¢ÃÂÃÂ check console");
    }
    ...
    <div style={{marginTop:10}}>
      <div className="row" style={{justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
        ...
        <label className="btn primary" style={{cursor:"pointer",display:"inline-flex",alignItems:"center",gap:6}}>
          {uploading ? "UploadingÃÂ¢ÃÂÃÂ¦" : "Attach photo"}
          <input
            ref={fileRef}
            type="file"
            accept="image/*"
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Shared: DimEditor ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
    ...
    <div style={{marginTop:8}}>
      <div className="row" style={{alignItems:"flex-end"}}>
        <div style={{flex:1,minWidth:90}}>
          ...
          <input className="input" type="text" inputMode="numeric" pattern="[0-9]*" placeholder="ÃÂ¢ÃÂÃÂ"
        ...
        <button className={`btn ${dirty?"primary":""}`} disabled={!dirty||saving} onClick={save}>
          {saving ? "SavingÃÂ¢ÃÂÃÂ¦" : dirty ? "Save" : "Saved"}
        </button>
      </div>
    </div>
  );
...
/* Ã¢ÂÂÃ¢ÂÂ FR Dashboard Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */

/* Ã¢ÂÂÃ¢ÂÂ FR Dashboard Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
...
/* ââ FR Delivery Tab (rebuilt) âââââââââââ */
...
/* Ã¢ÂÂÃ¢ÂÂ FR Delivery Detail (inline) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
  ...
  return (
    <div className="card" style={{margin:8,background:"#1a2332"}}>
      <div className="small" style={{marginBottom:8}}>
        SR#{door.sr_no} ÃÂ· {door.door_type} ÃÂ· {door.floor} / {door.apt_no} / {door.door_location}
      </div>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
      ...
      {(door.qty_hinges > 0 || door.qty_fhc_lock > 0 || door.qty_door_closer > 0 || door.qty_flush_bolt > 0) && (
        <div className="small" style={{marginTop:8,color:"#aaa"}}>
          {door.qty_hinges > 0 && <span>Hinges: {door.qty_hinges}x ÃÂ· </span>}
          {door.qty_fhc_lock > 0 && <span>FHC Lock: {door.qty_fhc_lock}x ÃÂ· </span>}
          {door.qty_door_closer > 0 && <span>Door Closer: {door.qty_door_closer}x ÃÂ· </span>}
      ...
      {(door.hw_lock_color || door.hw_cylinder_color || door.hw_handle_color || door.hw_stopper_color) && (
        <div className="small" style={{marginTop:4,color:"#aaa"}}>
          ...
          {door.hw_cylinder_color && <span> ÃÂ· Cyl: {door.hw_cylinder_color}</span>}
          {door.hw_handle_color && <span> ÃÂ· Handle: {door.hw_handle_color}</span>}
          {door.hw_stopper_color && <span> ÃÂ· Stopper: {door.hw_stopper_color}</span>}
        </div>
      )}
    </div>
  );
...
/* Ã¢ÂÂÃ¢ÂÂ FR Installation Tab Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
  ...
  return (
    <div>
      <div style={{display:"flex",gap:12,marginBottom:12,flexWrap:"wrap",alignItems:"center"}}>
        ...
        <input className="sel" placeholder="Search sr / apt / roomÃ¢ÂÂ¦" value={search} onChange={e => { setSearch(e.target.value); setPage(0); }} style={{minWidth:180}} />
      </div>
...
/* Ã¢ÂÂÃ¢ÂÂ FR Installation Detail (inline) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ */
    ...
    <div className="card" style={{margin:8,background:"#1a2332"}}>
      ...
      <table className="tbl" style={{width:"auto",marginBottom:16}}>
        <tbody>
          ...
          <tr><td className="small">Floor / Apt</td><td>{door.floor} ÃÂ· {door.apt_no}</td></tr>
      ...
      <div style={{marginBottom:16}}>
        ...
        <div className="small" style={{marginTop:4}}>
          Width: {door.width} ÃÂ· Height: {door.height} ÃÂ· Thickness: {door.thickness} ÃÂ· Opening: {door.opening_direction} ÃÂ· Architraves: {door.architraves}
        </div>
      </div>
      ...
      {(door.hw_lock_color || door.hw_cylinder_color || door.hw_handle_color || door.hw_stopper_color) && (
        <div style={{marginBottom:16}}>
          ...
          <div className="small" style={{marginTop:4}}>
            {door.hw_lock_color && <span>Lock: {door.hw_lock_color} ÃÂ· </span>}
            {door.hw_cylinder_color && <span>Cylinder: {door.hw_cylinder_color} ÃÂ· </span>}
            {door.hw_handle_color && <span>Handle: {door.hw_handle_color} ÃÂ· </span>}
